...
<div class="mb-3">
    ...
    <div class="row g-3">
        <div class="col-md-6">
            ...
            <input type="file" id="imagen1Edit" name="imagen_1" accept="image/*" style="display: none" />
        </div>
        <div class="col-md-6">
            ...
            <input type="file" id="imagen2Edit" name="imagen_2" accept="image/*" style="display: none" />
        </div>
    </div>
</div>
